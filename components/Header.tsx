...
export default function Header({ searchQuery, onSearchChange }: HeaderProps) {
  ...
  return (
    <header className="bg-[#1a56db] text-white px-6 py-3">
      <div className="max-w-7xl mx-auto flex items-center">
        ...
        <div className="flex-1 flex justify-end">
          <Link
            href="/cart"
            className="flex items-center gap-2 bg-[#1e3a8a] hover:bg-[#1e40af] transition-colors px-4 py-2 rounded-lg font-medium text-sm whitespace-nowrap"
          >
